	...
	<td align="center"  style="font-size:14px; color:#cc0000 !important; padding:7px;">
		<b style="color:#cc0000 !important;">Please provide a Credit Card to complete the order. There will be no charge to your card unless it is necessary to initiate our Market Loss Policy in the event of you canceling or defaulting on payment.</b>
	</td>
	<!-- agree -->
	    </tr>
	  </table>
...
<?php } ?>
	<form id="authorizenet_form" class="validate-creditcard">
	...
	<div id="cc-logo"><img src="image/creditcards.jpg"></div>
	  <table width="100%">	
	    <tr>
	...
	<!-- agree -->
	<td align="center" style="font-size:14px; color:#cc0000 !important; padding:7px;">
	 <b style="color:#cc0000 !important;">Again there will be no charge to your card unless it is necessary to initiate our Market Loss Policy.</b>
	</td>
	<!-- agree -->
	    </tr>
	  </table>
