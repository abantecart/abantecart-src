...
class ControllerResponsesExtensionDefaultAuthorizeNet extends AController
{
    ...
    public function buildCCForm()
    {
        ...
        $this->data['cc_owner_firstname'] = HtmlElementFactory::create(
            [
                'type'        => 'input',
        ...
        $this->data['cc_owner_lastname'] = HtmlElementFactory::create(
            [
                'type'        => 'input',
        ...
        $this->data['cc_cvv2'] = HtmlElementFactory::create(
            [
                'type'  => 'input',
                'name'  => 'cc_cvv2',
                'value' => '',
