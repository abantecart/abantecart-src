...
$this->db->query("INSERT INTO ".DB_PREFIX."languages (`name`,`code`,`locale`,`image`,`directory`,`filename`,`sort_order`, `status`)
				  VALUES ('Español', 'es', 'es_ES.UTF-8,es_ES,spanish', 'extensions/default_spanish/storefront/language/spanish/flag.png','spanish','spanish','2',0);");
...
$this->db->query("INSERT INTO ".DB_PREFIX."zone_descriptions 
