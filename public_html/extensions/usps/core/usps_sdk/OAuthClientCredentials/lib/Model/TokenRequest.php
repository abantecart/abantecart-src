...
class TokenRequest implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['scope'] = isset($data['scope']) ? $data['scope'] : '';
    }
     ...
     * Sets grant_type
     *
     * @param string $grant_type The OAuth standard flow being requested by the client application.
     *
     * @return $this
     */
     ...
     * Sets scope
     *
     * @param string $scope The OAuth2 scope being requested. A client application may request a subset of scope that has already been configured during registration.  The default scope registered for the client application is used as default when the scope is omitted.  **Only specify the scope in the request when the client application requires less scope, i.e. less access to APIs, than the default.**
     *
     * @return $this
     */
