...
class IndiciaRequestImageInfo implements ModelInterface, ArrayAccess
{
     ...
     * Sets image_type
     *
     * @param string $image_type The type of indicia image requested. If omitted then the default image type is PDF.  * 'PDF'  * 'TIFF'  * 'JPG'  * 'PNG'  * 'GIF'  * 'SVG'
     *
     * @return $this
     */
     ...
     * Sets label_type
     *
     * @param string $label_type Ability to select the indicia image size.  If omitted then the default indicia size is 2X1.5LABEL. - Using `2X1.5LABEL` will return the image in the `indiciaImage` response field. - Using `IMI_DATA_ONLY` will return the IMI data in the `indiciaIMI` response field and not populate the `indiciaImage` field.
     *
     * @return $this
     */
