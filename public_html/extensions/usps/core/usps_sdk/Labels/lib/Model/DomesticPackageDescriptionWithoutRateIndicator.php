<?php
/**
 * DomesticPackageDescriptionWithoutRateIndicator
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * DomesticPackageDescriptionWithoutRateIndicator Class Doc Comment
 *
 * @category Class
 * @package  USPS\Labels
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DomesticPackageDescriptionWithoutRateIndicator extends BaseDomesticPackageDescription 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DomesticPackageDescriptionWithoutRateIndicator';
    ...
    const PACKAGING_TYPE_CONNECT_LOCAL_FLAT_RATE_BOX = 'CONNECT_LOCAL_FLAT_RATE_BOX';
    const PACKAGING_TYPE_CONNECT_LOCAL_SMALL_FLAT_RATE_BAG = 'CONNECT_LOCAL_SMALL_FLAT_RATE_BAG';
    const PACKAGING_TYPE_CONNECT_LOCAL_LARGE_FLAT_RATE_BAG = 'CONNECT_LOCAL_LARGE_FLAT_RATE_BAG';
    ...
    public function getPackagingTypeAllowableValues()
    {
        return [
            ...
            self::PACKAGING_TYPE_CONNECT_LOCAL_FLAT_RATE_BOX
            self::PACKAGING_TYPE_CONNECT_LOCAL_SMALL_FLAT_RATE_BAG
            self::PACKAGING_TYPE_CONNECT_LOCAL_LARGE_FLAT_RATE_BAG
        ];
    }
