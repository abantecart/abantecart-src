 ...
 *
 * @category Class
 * @description The address of the business involved. The senderAddress can be different from the fromAddress when the business address is not where the package is being shipped from.  Notes: - The First and Last Name or Firm Name are always required. - &#x60;senderAddress&#x60; is required when the &#x60;shipperVisibilityMethod&#x60; field is set to &#x60;SENDER_INFORMATION&#x60;.
 * @package  USPS\Labels
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
