<?php
/**
 * AllOfReturnLabelRequestSenderAddress
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * AllOfReturnLabelRequestSenderAddress Class Doc Comment
 *
 * @category Class
 * @description The address of the business involved (typically the sender of the original package). The &#x60;senderAddress&#x60; can be different from the &#x60;toAddress&#x60; when the business address is not where the package is being shipped to.  Notes: * The First and Last Name or Firm Name are always required. * &#x60;senderAddress&#x60; is required when the &#x60;shipperVisibilityMethod&#x60; field is set to &#x60;SENDER_INFORMATION&#x60;.
 * @package  USPS\Labels
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AllOfReturnLabelRequestSenderAddress extends DomesticLabelSenderAddress 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AllOfReturnLabelRequestSenderAddress';
