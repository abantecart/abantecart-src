...
/**
 * PackageOptionsOmas Class Doc Comment
 *
 * @category Class
 * @description Fields specific to Official Mail Accounting System (OMAS).  Used for Federal Agencies.
 * @package  USPS\Labels
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PackageOptionsOmas implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PackageOptions_omas';
    ...
    protected static $setters = [
        'chargeback_code' => 'setChargebackCode'
    ];
    ...
    protected static $getters = [
        'chargeback_code' => 'getChargebackCode'
    ];
    ...
    {
        $this->container['chargeback_code'] = isset($data['chargeback_code']) ? $data['chargeback_code'] : null;
    }
    ...
    /**
     * Gets chargeback_code
     *
     * @return string
     */
    public function getChargebackCode()
    {
        return $this->container['chargeback_code'];
    }

    /**
     * Sets chargeback_code
     *
     * @param string $chargeback_code Code used with OMAS transactions.
     *
     * @return $this
     */
    public function setChargebackCode($chargeback_code)
    {
        $this->container['chargeback_code'] = $chargeback_code;
