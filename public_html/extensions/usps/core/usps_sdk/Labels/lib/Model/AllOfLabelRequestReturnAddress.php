<?php
/**
 * AllOfLabelRequestReturnAddress
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * AllOfLabelRequestReturnAddress Class Doc Comment
 *
 * @category Class
 * @description The address where the package should be returned to if it is deemed undeliverable or returned to sender. This address will be printed in the return address block of the label.  Note: * The First and Last Name or Firm Name are always required.
 * @package  USPS\Labels
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AllOfLabelRequestReturnAddress extends DomesticLabelAddress 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AllOfLabelRequestReturnAddress';
