...
/**
 * LabelBrandingDeleteResponse Class Doc Comment
 *
 * @category Class
 * @description Label Branding Image Delete Response
 * @package  USPS\Labels
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LabelBrandingDeleteResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LabelBrandingDeleteResponse';
     ...
     * Sets image_name
     *
     * @param string $image_name The name of the image that was successfully deleted.
     *
     * @return $this
     */
     ...
     * Sets image_uuid
     *
     * @param string $image_uuid The UUID of the image that was successfully deleted.
     *
     * @return $this
     */
