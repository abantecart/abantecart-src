<?php
/**
 * AllOfReturnLabelRequestToAddress
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * AllOfReturnLabelRequestToAddress Class Doc Comment
 *
 * @category Class
 * @description The address where the return package is being shipped to. The ZIP Code™ in the &#x60;toAddress&#x60; object is used to calculate pricing.  Notes: * The First and Last Name or Firm Name are always required. * For return labels, the &#x60;toAddress&#x60; ZIP Plus 4 is looked up by the API, unless the &#x60;ignoreBadAddress&#x60; field is set to true or the address cannot be found. If &#x60;ignoreBadAddress&#x60; field is true then ZIP Plus 4 is required.
 * @package  USPS\Labels
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AllOfReturnLabelRequestToAddress extends DomesticLabelAddress 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AllOfReturnLabelRequestToAddress';
