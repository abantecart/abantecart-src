...
/**
 * BrandingPatchRequest Class Doc Comment
 *
 * @category Class
 * @description Request to update branding information for labels using JSON Patch. Refer to the IETF JSON PATCH specification at https://datatracker.ietf.org/doc/html/rfc6902 for detailed guidelines.
 * @package  USPS\Labels
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BrandingPatchRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BrandingPatchRequest';
