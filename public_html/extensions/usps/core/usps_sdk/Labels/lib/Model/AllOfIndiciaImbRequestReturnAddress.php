<?php
/**
 * AllOfIndiciaImbRequestReturnAddress
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * AllOfIndiciaImbRequestReturnAddress Class Doc Comment
 *
 * @category Class
 * @description The address where the letter, flat, or card is being mailed from.  Address elements streetAddress, city, state, ZIPCode are required.  First and Last Name or Firm are also required.
 * @package  USPS\Labels
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AllOfIndiciaImbRequestReturnAddress extends IndiciaImbAddress 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AllOfIndiciaImbRequestReturnAddress';
