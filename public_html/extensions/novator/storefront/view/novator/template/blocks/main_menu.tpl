...
//                    );
					...
					<li class="nav-item dropdown mega-menu"><a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside">Shop</a>
						<div class="dropdown-menu dropdown-mega-menu">
							<div class="container">
								<div class="row">
									<div class="col-lg-10">
										<div class="row">
											<div class="col-3"><h6 class="category-title">Bed linen</h6>
												<ul class="list-unstyled category-sub-links">
													<li><a href="#">Bdsheets</a></li>
													<li><a href="#">Bedding Sets</a></li>
													<li><a href="#">Blankets, Dohars</a></li>
													<li><a href="#">Comforters</a></li>
													<li><a href="#">Bed Covers</a></li>
													<li><a href="#">Mattress Protectors</a></li>
												</ul>
											</div>
											<div class="col-3"><h6 class="category-title">Cushions & Pillows</h6>
												<ul class="list-unstyled category-sub-links">
											...
											<div class="col-3"><h6 class="category-title">Kitchen</h6>
												<ul class="list-unstyled category-sub-links">
													<li><a href="#">Cookware & Ctlery</a></li>
													<li><a href="#">Bakeware</a></li>
													<li><a href="#">Kitchen Tools</a></li>
													<li><a href="#">Kitchen Aprons, Gloves</a></li>
													<li><a href="#">Kitchen organisers</a></li>
												</ul>
												<h6 class="category-title mt-3">Home Essentials</h6></div>
											<div class="col-3"><h6 class="category-title">Home Decore</h6>
												<ul class="list-unstyled category-sub-links">
													...
													<li><a href="#">Lamp, Diyas</a></li>
												</ul>
											</div>
										</div>
									</div>
									<div class="col-lg-2"><h6 class="category-title"></h6>
										<ul class="list-unstyled category-sub-links">
											<li><a href="#">Home Fragnrances</a></li>
											<li><a href="#">Plants & Flowers</a></li>
											<li><a href="#">Tables Napkins</a></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<li class="nav-item dropdown mega-menu"><a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside">Makeup</a>
						<div class="dropdown-menu dropdown-mega-menu">
							<div class="container">
								<div class="row text-center">
									<div class="col-3"><img src="assets/images/menu/img-prod-1.png" alt="images" class="img-fluid" width="235" height="240"><h6
												class="category-title menu-img-captipn">Bed linen</h6></div>
									<div class="col-3"><img src="assets/images/menu/img-prod-2.png" alt="images" class="img-fluid" width="235" height="240"><h6
												class="category-title menu-img-captipn">Cushions & Pillows</h6></div>
									<div class="col-3"><img src="assets/images/menu/img-prod-3.png" alt="images" class="img-fluid" width="235" height="240"><h6
												class="category-title menu-img-captipn">Kitchen</h6></div>
									<div class="col-3"><img src="assets/images/menu/img-prod-1.png" alt="images" class="img-fluid" width="235" height="240"><h6
												class="category-title menu-img-captipn">Home Decore</h6></div>
								</div>
							</div>
						</div>
					</li>
