<div id="menuoffcanvas" class="offcanvas menu-offcanvas offcanvas-end" tabindex="-1"
    ...
    <div class="offcanvas-header">
        ...
        <a href="<?php echo $this->html->getSecureUrl('account/account') ?>" class="btn btn-primary p-2">
            <i class="bi bi-person"></i>
            <?php echo $text_account; ?>
        </a>
        <a href="javascript:void(0)"
           class="theme-change ms-auto"
           id="theme-switcher"><i class="bi bi-sun-fill icon-dark"></i> <i
                    class="bi bi-moon-stars-fill icon-light"></i>
        </a>
    </div>
    <div class="offcanvas-body">
        <div class="scroll-div mt-5">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <a href="<?php echo $this->html->getSecureUrl('product/special') ?>"
                           class="accordion-button collapsed no-icon"><?php echo $text_special; ?>
                        </a>
                    </h2>
                </div>
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <a href="<?php echo $this->html->getSecureUrl('account/history') ?>"
                    ...
                    <div class="list-group list-group-flush mt-4">
                        <?php foreach ($mobile_menu_contents as $item) { ?>
                            <a href="<?php echo $item['href'] ?>"
                               class="list-group-item list-group-item-action border-0"><?php echo $item['text']; ?></a>
                        <?php } ?>
                    </div>
                </div>
            <?php } ?>
