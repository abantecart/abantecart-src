...
<div class="products">
    ...
    <div class="d-flex mb-4">
        <div class="flex-shrink-0"><img src="<?php echo $product['thumb']['thumb_url']; ?>" alt="image" class="img-fluid h-auto"></div>
        <div class="flex-grow-1 ms-3">
            ...
            <div class="d-flex align-items-center justify-content-between">
                <div class="input-group input-group-sm mx-auto" style="width: 150px;">
                    <button title="Min: 1" class="minus-qnty input-group-text btn btn-outline-danger">−</button>
                    <input type="text" name="quantity[111]" id="cart_quantity111" value="1" placeholder="" class="form-control text-center fw-bold short form-control-sm text-center" size="6" min="1">
