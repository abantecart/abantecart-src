<?php if ($this->cart->hasShipping()) {
    ...
    <div class="flex-item flex-fill pb-1 fc-address-card-wrapper">
        <div class="d-flex justify-content-between col-12 bg-light-primary border pe-sm-0 pe-xl-1 pe-sm-0 fc-address-card">
...
if ($show_payment == true) {
    ...
    <div class="flex-item flex-fill ps-md-1 ps-0 pt-0 pb-1 fc-address-card-wrapper">
        <div class="d-flex justify-content-between col-12 bg-light-primary border fc-address-card">
