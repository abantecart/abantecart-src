            ...
            <div class="sticky-md-top product-sticky">
                <div id="carouselExampleCaptions" class="carousel slide ecomm-prod-slider" data-bs-ride="carousel">
                    <div class="carousel-inner bg-light rounded position-relative">
                        <div class="carousel-item active"><img src="assets/images/prod/img-prod-1.png"
                                                               data-zoom="assets/images/prod/img-prod-1.png"
                                                               class="demo-trigger d-block w-100" alt="Product images">
                        </div>
                        <div class="carousel-item"><img src="assets/images/prod/img-prod-2.png"
                                                        data-zoom="assets/images/prod/img-prod-2.png"
                                                        class="demo-trigger d-block w-100" alt="Product images"></div>
                        <div class="carousel-item"><img src="assets/images/prod/img-prod-3.png"
                                                        data-zoom="assets/images/prod/img-prod-3.png"
                                                        class="demo-trigger d-block w-100" alt="Product images"></div>
                        <div class="carousel-item"><img src="assets/images/prod/img-prod-4.png"
                                                        data-zoom="assets/images/prod/img-prod-4.png"
                                                        class="demo-trigger d-block w-100" alt="Product images"></div>
                        <div class="carousel-item"><img src="assets/images/prod/img-prod-5.png"
                                                        data-zoom="assets/images/prod/img-prod-5.png"
                                                        class="demo-trigger d-block w-100" alt="Product images"></div>
                        <div class="carousel-item"><img src="assets/images/prod/img-prod-1.png"
                                                        data-zoom="assets/images/prod/img-prod-1.png"
                                                        class="demo-trigger d-block w-100" alt="Product images"></div>
                        <div class="carousel-item"><img src="assets/images/prod/img-prod-2.png"
                                                        data-zoom="assets/images/prod/img-prod-2.png"
                    ...
                    <ul class="carousel-indicators position-relative product-carousel-indicators my-sm-3 mx-0">
                        <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="0" class="w-25 h-auto active"
                            aria-current="true"><img src="assets/images/prod/img-prod-1.png"
                                                     class="d-block wid-100 rounded" alt="Product images"></li>
                        <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="1" class="w-25 h-auto"><img
                                    src="assets/images/prod/img-prod-2.png" class="d-block wid-100 rounded"
                                    alt="Product images"></li>
                        <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="2" class="w-25 h-auto"><img
                                    src="assets/images/prod/img-prod-3.png" class="d-block wid-100 rounded"
                                    alt="Product images"></li>
                        <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="3" class="w-25 h-auto"><img
                                    src="assets/images/prod/img-prod-4.png" class="d-block wid-100 rounded"
                                    alt="Product images"></li>
                        <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="4" class="w-25 h-auto"><img
                                    src="assets/images/prod/img-prod-5.png" class="d-block wid-100 rounded"
                                    alt="Product images"></li>
                        <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="5" class="w-25 h-auto"><img
                                    src="assets/images/prod/img-prod-1.png" class="d-block wid-100 rounded"
                                    alt="Product images"></li>
                        <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="6" class="w-25 h-auto"><img
                                    src="assets/images/prod/img-prod-2.png" class="d-block wid-100 rounded"
                                    alt="Product images"></li>
                        <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="7" class="w-25 h-auto"><img
                                    src="assets/images/prod/img-prod-3.png" class="d-block wid-100 rounded"
                                    alt="Product images"></li>
                    </ul>
                </div>
