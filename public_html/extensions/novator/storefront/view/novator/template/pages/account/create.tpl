...
<?php } ?>
    ...
    <?php echo $form['form_open']; ?>
        ...
        <div class="card mb-4">
            <div class="card-body">
                <h5 class="border-bottom pb-3 mb-4"><?php echo $text_your_details; ?></h5>
        ...
        <div class="card mb-4">
            <div class="card-body">
                <h5 class="border-bottom pb-3 mb-4"><?php echo $text_your_address; ?></h5>
        ...
        <div class="card mb-4">
            <div class="card-body">
                <h5 class="border-bottom pb-3 mb-4"><?php echo $text_login_details; ?></h5>
        ...
        <div class="card mb-4">
            <div class="card-body">
                <h5 class="border-bottom pb-3 mb-4"><?php echo $text_newsletter; ?></h5>
