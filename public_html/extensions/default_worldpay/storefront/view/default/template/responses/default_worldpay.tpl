<!-- <p>WORLDPAY template INSERTED HERE </p>  -->
<form action="<?php echo str_replace('&', '&amp;', $action); ?>" method="post" id="checkout">
	...
	<input type="hidden" name="MC_callback" value="<?php echo $MC_callback; ?>"/>
	<input type="hidden" name="signature" value="<?php echo $signature; ?>"/>


	<div class="form-group action-buttons">
		<div class="col-md-12">
			<button class="btn btn-orange pull-right lock-on-click" onclick="$('#checkout').submit();"
					title="<?php echo $button_confirm; ?>" type="submit">
				<i class="fa fa-check"></i>
				<?php echo $button_confirm; ?>
			</button>
			<a href="<?php echo str_replace('&', '&amp;', $back); ?>" class="btn btn-default mr10"
			   title="<?php echo $button_back; ?>">
