...
$lng_code = "fi";
$lng_name = "Suomi";
$lng_directory = "finnish";
$lng_locale = "fi_FI.UTF-8,fi_FI,fi-fi,finnish";
$lng_flag_path = "extensions/default_finnish/storefront/language/finnish/flag.png";
...
$xml = simplexml_load_file(DIR_EXT . 'default_finnish/menu.xml');
$routes = array(
