...
$lng_code = "sl";
$lng_name = "Slovenščina";
$lng_directory = "slovene";
$lng_locale = "sl_SI.UTF-8,sl_SI,sl-si,slovene";
$lng_flag_path = "extensions/default_slovene/storefront/language/slovene/flag.png";
...
$xml = simplexml_load_file(DIR_EXT . 'default_slovene/menu.xml');
$routes = array(
