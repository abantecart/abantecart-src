...
$lng_code = "tw";
$lng_name = "繁體中文";
$lng_directory = "traditional_chinese";
$lng_locale = "zh_TW.UTF-8,zh_TW,zh-tw,tchinese";
$lng_flag_path = "extensions/default_traditional_chinese/storefront/language/traditional_chinese/flag.png";
...
$xml = simplexml_load_file(DIR_EXT . 'default_traditional_chinese/menu.xml');
$routes = array(
