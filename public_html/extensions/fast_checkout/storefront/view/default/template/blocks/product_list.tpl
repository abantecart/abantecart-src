<div class="thumbnails list-inline">
    ...
    if ($products) {
        ...
        foreach ($products as $product) {
            ...
            $item['rating'] =
                    $product['rating']
                    ? "<img class=\"rating\" src='".$this->templateResource('/image/stars_'.$product['rating'].'.png')."' alt='".$product['stars']."' width='64' height='12' />"
                    : '';
                    ...
                    <?php if ($display_price) { ?>
                        <div class="pricetag jumbotron">
                            ...
                            <?php } else {
                                ...
                                <?php } else { ?>
                                    <?php if (!$this->getHookVar('product_add_to_cart_html_'
                                        .$product['product_id'])) { ?>
                                    ...
                                    <?php } else { ?>
                                        <?php echo $this->getHookVar('product_add_to_cart_html_'
                                            .$product['product_id']); ?>
                                    <?php } ?>
                                <?php }
                            } ?>
