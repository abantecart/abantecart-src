<a id="product_add_to_cart" href="Javascript:void(0)" class="shadow cart btn btn-outline-primary btn-lg mx-2 mb-3">
...
<a id="product_buy_now_btn" href="#" onclick="$(this).closest('form').attr('action', '<?php echo $buynow_url;?>').submit(); return false;"
   class="shadow cart btn btn-primary btn-lg mx-2 mb-3">
