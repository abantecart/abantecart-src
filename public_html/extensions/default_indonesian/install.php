...
$lng_code = "id";
$lng_name = "Bahasa Indonesia";
$lng_directory = "indonesian";
$lng_locale = "id_ID.UTF-8,id_ID,id-id,indonesian";
$lng_flag_path = "extensions/default_indonesian/storefront/language/indonesian/flag.png";
...
$xml = simplexml_load_file(DIR_EXT . 'default_indonesian/menu.xml');
$routes = array(
