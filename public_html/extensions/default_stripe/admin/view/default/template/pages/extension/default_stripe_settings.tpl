...
<div id="content" class="panel panel-default">
	...
	<?php } else { ?>
		...
		<div class="panel-body panel-body-nopadding tab-content col-xs-12 <?php if ($test_mode) {
			echo 'status_test';
		} ?>">
			...
			if ($connected && in_array($name,
							array ('default_stripe_test_mode', 'default_stripe_sk_test', 'default_stripe_sk_live'))
			) {
				continue;
			}
			?>

			<div id="<?php echo $name; ?>" class="form-group <?php if (!empty($error[$name])) {
				echo "has-error";
			} ?>">
				<label class="control-label col-sm-3 col-xs-12"
					   for="<?php echo $field->element_id; ?>"><?php echo ${$name}; ?></label>
