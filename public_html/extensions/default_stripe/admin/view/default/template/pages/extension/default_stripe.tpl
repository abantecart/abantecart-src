...
<div class="tab-content">
	...
	<div class="panel-body panel-body-nopadding">
		...
		<label class="h4 heading"><?php echo $this->config->get('default_stripe_test') ? $text_api_credentials_sandbox : $text_api_credentials; ?></label>
		...
		<div class="form-group">
			<label class="control-label col-sm-4 col-xs-12" ><?php echo $this->config->get('default_stripe_test') ? $text_api_credentials_note_sandbox : $text_api_credentials_note; ?></label>
			<div class="input-group afield <?php echo $widthcasses; ?>">
				<?php
				$title = ($this->config->get('default_stripe_test') ? $button_get_api_credentials_sandbox : $button_get_api_credentials);
				echo $this->html->buildElement( array(
					'type' => 'button',
