...
$result = copy(DIR_EXT.'default_pp_pro/image/pp_cc_mark_37x23.jpg', DIR_RESOURCE.'image/pp_cc_mark_37x23.jpg');

$resource = array(
	'language_id' => $this->config->get('storefront_language_id'),
	'name' => array(),
	'title' => 'default_pp_pro_default_storefront_icon',
	'description' => 'PayPal Pro Default Storefront Icon',
