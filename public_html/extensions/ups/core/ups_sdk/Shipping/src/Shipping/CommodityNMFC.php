...
class CommodityNMFC implements ModelInterface, ArrayAccess
{
     ...
     * Sets sub_code
     *
     * @param string $sub_code Specifies the Commodity's NMFC sub code.  Needs to be provided when the SubCode associated with the PrimeCode is other than 00. UPS defaults the sub value to 00 if not provided. If provided the Sub Code should be associated with the PrimeCode of the NMFC.
     *
     * @return $this
     */
