 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AddressPOE implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Address_POE';
     ...
     *
     * @param string $state_province_code The code of the address's admininstrative division (state, province, distict, prefecture, etc...).
     *
     * @return $this
     */
