...
/**
 * NegotiatedRateChargesRateModifier Class Doc Comment
 *
 * @category Class
 * @description Container for returned Rate Modifier information.  Applies if SubVersion is 2407 or greater and supports only for oAuth shipments.
 * @package  UPS\Shipping
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NegotiatedRateChargesRateModifier implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NegotiatedRateCharges_RateModifier';
     ...
     * Sets modifier_type
     *
     * @param string $modifier_type Rate Modifier Type . Example- \"ORM\"  Applies if SubVersion is 2407 or greater and supports only for oAuth shipments.
     *
     * @return $this
     */
     ...
     * Sets modifier_desc
     *
     * @param string $modifier_desc Rate Modifier Description . Example- \"Origin Modifier\"  Applies if SubVersion is 2407 or greater and supports only for oAuth shipments.
     *
     * @return $this
     */
     ...
     * Sets amount
     *
     * @param string $amount Amount . Example- \"-1.00\",\"0.25\"  It contains positive or negative values.  Applies if SubVersion is 2407 or greater and supports only for oAuth shipments.
     *
     * @return $this
     */
