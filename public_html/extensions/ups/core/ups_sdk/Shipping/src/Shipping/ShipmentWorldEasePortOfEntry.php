...
/**
 * ShipmentWorldEasePortOfEntry Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ShipmentWorldEasePortOfEntry implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Shipment_WorldEase_PortOfEntry';
    ...
    protected static $swaggerTypes = [
        'name' => 'string',
        'clearance_port_code' => 'string',
        'consignee' => 'string',
        'address' => '\UPS\Shipping\Shipping\AddressPOE'
    ];
    ...
    protected static $attributeMap = [
        'name' => 'Name',
        'clearance_port_code' => 'ClearancePortCode',
        'consignee' => 'Consignee',
        'address' => 'Address'
    ];
    ...
    protected static $setters = [
        'name' => 'setName',
        'clearance_port_code' => 'setClearancePortCode',
    ...
    protected static $getters = [
        'name' => 'getName',
        'clearance_port_code' => 'getClearancePortCode',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['clearance_port_code'] = isset($data['clearance_port_code']) ? $data['clearance_port_code'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['clearance_port_code'] === null) {
            $invalidProperties[] = "'clearance_port_code' can't be null";
        }
     ...
     * Sets name
     *
     * @param string $name Port of entry name
     *
     * @return $this
     */
    ...
    /**
     * Gets clearance_port_code
     *
     * @return string
     */
    public function getClearancePortCode()
    {
        return $this->container['clearance_port_code'];
    }

    /**
     * Sets clearance_port_code
     *
     * @param string $clearance_port_code Port code
     *
     * @return $this
     */
    public function setClearancePortCode($clearance_port_code)
    {
        $this->container['clearance_port_code'] = $clearance_port_code;
     ...
     * Sets consignee
     *
     * @param string $consignee Port of entry consignee
     *
     * @return $this
     */
     ...
     * Gets address
     *
     * @return \UPS\Shipping\Shipping\AddressPOE
     */
     ...
     * Sets address
     *
     * @param \UPS\Shipping\Shipping\AddressPOE $address address
     *
     * @return $this
     */
