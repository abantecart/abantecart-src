<?php
/**
 * GlobalTaxInformationShipperTypeValueTest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * GlobalTaxInformationShipperTypeValueTest Class Doc Comment
 *
 * @category    Class
 * @description The value for idNumber_Consumer_TypeCode which satisfies Tax-ID Threshold Code is  ‘01’&#x3D;Business, ‘02’&#x3D;Consumer/Individual,      ‘NA’&#x3D; ‘Not Applicable’
 * @package     UPS\Shipping
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GlobalTaxInformationShipperTypeValueTest extends TestCase
{
    ...
    /**
     * Test "GlobalTaxInformationShipperTypeValue"
     */
    public function testGlobalTaxInformationShipperTypeValue()
    {
    }
}
