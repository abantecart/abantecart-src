<?php
/**
 * GlobalTaxInformationOriginCountryShipmentValueTest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * GlobalTaxInformationOriginCountryShipmentValueTest Class Doc Comment
 *
 * @category    Class
 * @description The value for origin_country_shipment_value which satisfies Tax-ID Threshold Code is  ‘01’&#x3D;Yes, ‘02’&#x3D;No, ‘NA’&#x3D; ‘Not Applicable’
 * @package     UPS\Shipping
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GlobalTaxInformationOriginCountryShipmentValueTest extends TestCase
{
    ...
    /**
     * Test "GlobalTaxInformationOriginCountryShipmentValue"
     */
    public function testGlobalTaxInformationOriginCountryShipmentValue()
    {
    }
}
