<?php
/**
 * NegotiatedRateChargesBaseServiceCharge
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * NegotiatedRateChargesBaseServiceCharge Class Doc Comment
 *
 * @category Class
 * @package  UPS\Rating
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NegotiatedRateChargesBaseServiceCharge implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NegotiatedRateCharges_BaseServiceCharge';
     ...
     * Sets currency_code
     *
     * @param string $currency_code The IATA currency code associated with the base service Charge.
     *
     * @return $this
     */
     ...
     * Sets monetary_value
     *
     * @param string $monetary_value The value for base service charge.
     *
     * @return $this
     */
