...
class Destination implements ModelInterface, ArrayAccess
{
     ...
     * Sets url
     *
     * @param  $url It is an HTTP-based callback end point that is exposed by the client to receive event notification. This endpoint must be operational around the clock to ensure no event notifications are missed. If this endpoint is not continuously available, incoming events will be lost.
     *
     * @return $this
     */
     ...
     *
     * @param  $credential_type It is an open-entry field that indicates type of credentials supported by the client.
     *
     * @return $this
     */
     ...
     * Sets credential
     *
     * @param  $credential It is an opaque string meant for client authentication. If for any reason this credential changes then any event notification will fail until a new subscription is made.
     *
     * @return $this
     */
