...
namespace UPS\UPSTrackAlertEnhanced\UPSTrackAlertEnhanced;
...
class TrackSubsServiceRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'event_preference' => '',
        'destination' => '\UPS\UPSTrackAlertEnhanced\UPSTrackAlertEnhanced\Destination'
    ];
    ...
    protected static $setters = [
        ...
        'event_preference' => 'setEventPreference',
    ...
    protected static $getters = [
        ...
        'event_preference' => 'getEventPreference',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['event_preference'] = isset($data['event_preference']) ? $data['event_preference'] : null;
     ...
     * Sets locale
     *
     * @param  $locale Locale setting is composed of language code and country code, separated by an underscore. This field is reserved for future use.
     *
     * @return $this
     */
     ...
     * Sets country_code
     *
     * @param  $country_code Represents the country code. This field is reserved for future use.
     *
     * @return $this
     */
     ...
     *
     * @param  $tracking_number_list Represents list of tracking numbers in request.
     *
     * @return $this
     */
    ...
    /**
     * Gets event_preference
     *
     * @return 
     */
    public function getEventPreference()
    {
        return $this->container['event_preference'];
    }

    /**
     * Sets event_preference
     *
     * @param  $event_preference Represents scan/event preferences for the subscription endpoint, Place holder for Future use.
     *
     * @return $this
     */
    public function setEventPreference($event_preference)
    {
        $this->container['event_preference'] = $event_preference;
     ...
     * Gets destination
     *
     * @return \UPS\UPSTrackAlertEnhanced\UPSTrackAlertEnhanced\Destination
     */
     ...
     * Sets destination
     *
     * @param \UPS\UPSTrackAlertEnhanced\UPSTrackAlertEnhanced\Destination $destination destination
     *
     * @return $this
     */
