...
class TrackSubsServiceResponse implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param  $valid_tracking_numbers List of tracking numbers with successful subscription created.
     *
     * @return $this
     */
     ...
     *
     * @param  $invalid_tracking_numbers List of tracking numbers associated with errors preventing subscription creation.
     *
     * @return $this
     */
