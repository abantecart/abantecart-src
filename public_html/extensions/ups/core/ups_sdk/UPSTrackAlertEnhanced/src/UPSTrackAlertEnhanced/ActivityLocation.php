...
/**
 * ActivityLocation Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ActivityLocation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ActivityLocation';
     ...
     * Sets city
     *
     * @param  $city The physical address city.
     *
     * @return $this
     */
     ...
     * Sets state_province
     *
     * @param  $state_province The physical address state or province.
     *
     * @return $this
     */
     ...
     * Sets postal_code
     *
     * @param  $postal_code The physical address postal code (This field is blank until the delivery event occurs).
     *
     * @return $this
     */
     ...
     * Sets country
     *
     * @param  $country The physical address country.
     *
     * @return $this
     */
