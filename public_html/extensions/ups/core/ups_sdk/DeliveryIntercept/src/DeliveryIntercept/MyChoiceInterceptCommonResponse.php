...
/**
 * MyChoiceInterceptCommonResponse Class Doc Comment
 *
 * @category Class
 * @package  UPS\DeliveryIntercept
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MyChoiceInterceptCommonResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MyChoiceInterceptCommonResponse';
    ...
    protected static $attributeMap = [
        ...
        'my_choice_country' => 'myChoiceCountry'
    ];
    ...
    protected static $setters = [
        'addr_token' => 'setAddrToken',
        'my_choice_country' => 'setMyChoiceCountry'
    ];
    ...
    protected static $getters = [
        'addr_token' => 'getAddrToken',
        'my_choice_country' => 'getMyChoiceCountry'
    ];
    ...
    {
        $this->container['addr_token'] = isset($data['addr_token']) ? $data['addr_token'] : null;
        $this->container['my_choice_country'] = isset($data['my_choice_country']) ? $data['my_choice_country'] : null;
    }
     ...
     * @return 
     */
    public function getAddrToken()
    {
        return $this->container['addr_token'];
    }

    /**
     * Sets addr_token
     *
     * @param  $addr_token The token associated with the tracking number and one of the user's active enrollments.
     *
     * @return $this
     */
    public function setAddrToken($addr_token)
    {
        $this->container['addr_token'] = $addr_token;

        return $this;
    }

    /**
     * Gets my_choice_country
     *
     * @return 
     */
    public function getMyChoiceCountry()
    {
        return $this->container['my_choice_country'];
    }

    /**
     * Sets my_choice_country
     *
     * @param  $my_choice_country Will only be returned if notificationRequestType is DBD email or DBD phone. Indicates if My Choice is supported in the package's ship to country.   | CODE  | DESCRIPTION                                     | | :--:  | :--                                             | |       | No My Choice support check was done.            | | 0     | Area does not support My Choice functionality.  | | 1     | Area supports My Choice functionality.          |
     *
     * @return $this
     */
    public function setMyChoiceCountry($my_choice_country)
    {
        $this->container['my_choice_country'] = $my_choice_country;
