...
class SubscriptionFileOrigin implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \UPS\QuantumView\QuantumView\OriginPackageReferenceNumber[] $package_reference_number Package-level reference number.  **NOTE:** For versions >= v3, this element will always be returned as an array. For requests using version = v1 and v2, this element will be returned as an array if there is more than one object and a single object if there is only 1.
     *
     * @return $this
     */
     ...
     *
     * @param \UPS\QuantumView\QuantumView\OriginShipmentReferenceNumber[] $shipment_reference_number Container tag for shipment reference number.  **NOTE:** For versions >= v3, this element will always be returned as an array. For requests using version = v1 and v2, this element will be returned as an array if there is more than one object and a single object if there is only 1.
     *
     * @return $this
     */
