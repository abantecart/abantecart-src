...
class ExceptionUpdatedAddress implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \UPS\QuantumView\QuantumView\UpdatedAddressAddressExtendedInformation[] $address_extended_information Container for information about updated shipping address. It will be returned if there is any update due to exception.  **NOTE:** For versions >= v3, this element will always be returned as an array. For requests using version = v1 and v2, this element will be returned as an array if there is more than one object and a single object if there is only 1.
     *
     * @return $this
     */
