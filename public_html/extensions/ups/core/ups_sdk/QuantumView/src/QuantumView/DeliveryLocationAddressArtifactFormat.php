...
class DeliveryLocationAddressArtifactFormat implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \UPS\QuantumView\QuantumView\AddressArtifactFormatAddressExtendedInformation[] $address_extended_information Container tag for additional address information where package is delivered.  **NOTE:** For versions >= v3, this element will always be returned as an array. For requests using version = v1 and v2, this element will be returned as an array if there is more than one object and a single object if there is only 1.
     *
     * @return $this
     */
