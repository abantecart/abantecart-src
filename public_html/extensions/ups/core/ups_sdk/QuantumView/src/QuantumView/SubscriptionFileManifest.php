...
class SubscriptionFileManifest implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \UPS\QuantumView\QuantumView\ManifestReferenceNumber[] $reference_number Shipment-level reference numbers.  **NOTE:** For versions >= v3, this element will always be returned as an array. For requests using version = v1 and v2, this element will be returned as an array if there is more than one object and a single object if there is only 1.
     *
     * @return $this
     */
     ...
     * Sets package
     *
     * @param \UPS\QuantumView\QuantumView\ManifestPackage[] $package Defines a package.  **NOTE:** For versions >= v3, this element will always be returned as an array. For requests using version = v1 and v2, this element will be returned as an array if there is more than one object and a single object if there is only 1.
     *
     * @return $this
     */
