...
class TrackingApi
{
    ...
    /**
     * Operation referenceTrackingAPI
     *
     * Track by Reference Number
     *
     * @param  string $reference_number The reference number for which tracking information is requested. (required)
     * @param  string $trans_id An identifier unique to the request. (required)
     * @param  string $transaction_src Identifies the client/source application that is calling (required)
     * @param  string $locale Language and country code of the user, separated by an underscore. Default value is &#x27;en_US&#x27; (optional, default to en_US)
     * @param  string $from_pick_up_date The tracking information for the above reference number will be searched from this date (optional, default to currentDate-14)
     * @param  string $to_pick_up_date The tracking information for the above reference number will be searched till this date (optional, default to currentDate)
     * @param  string $ref_num_type The Reference number type which will define the tracking information is related to small package or fgv (optional, default to SmallPackage. Valid values: SmallPackage, fgv)
     *
     * @throws \UPS\Tracking\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \UPS\Tracking\Tracking\TrackApiResponse
     */
    public function referenceTrackingAPI($reference_number, $trans_id, $transaction_src, $locale = 'en_US', $from_pick_up_date = 'currentDate-14', $to_pick_up_date = 'currentDate', $ref_num_type = 'SmallPackage. Valid values: SmallPackage, fgv')
    {
        list($response) = $this->referenceTrackingAPIWithHttpInfo($reference_number, $trans_id, $transaction_src, $locale, $from_pick_up_date, $to_pick_up_date, $ref_num_type);
        return $response;
    }

    /**
     * Operation referenceTrackingAPIWithHttpInfo
     *
     * Track by Reference Number
     *
     * @param  string $reference_number The reference number for which tracking information is requested. (required)
     ...
     * @return array of \UPS\Tracking\Tracking\TrackApiResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function referenceTrackingAPIWithHttpInfo($reference_number, $trans_id, $transaction_src, $locale = 'en_US', $from_pick_up_date = 'currentDate-14', $to_pick_up_date = 'currentDate', $ref_num_type = 'SmallPackage. Valid values: SmallPackage, fgv')
    {
        $returnType = '\UPS\Tracking\Tracking\TrackApiResponse';
        $request = $this->referenceTrackingAPIRequest($reference_number, $trans_id, $transaction_src, $locale, $from_pick_up_date, $to_pick_up_date, $ref_num_type);
    ...
    /**
     * Operation referenceTrackingAPIAsync
     *
     * Track by Reference Number
     *
     * @param  string $reference_number The reference number for which tracking information is requested. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function referenceTrackingAPIAsync($reference_number, $trans_id, $transaction_src, $locale = 'en_US', $from_pick_up_date = 'currentDate-14', $to_pick_up_date = 'currentDate', $ref_num_type = 'SmallPackage. Valid values: SmallPackage, fgv')
    {
        return $this->referenceTrackingAPIAsyncWithHttpInfo($reference_number, $trans_id, $transaction_src, $locale, $from_pick_up_date, $to_pick_up_date, $ref_num_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation referenceTrackingAPIAsyncWithHttpInfo
     *
     * Track by Reference Number
     *
     * @param  string $reference_number The reference number for which tracking information is requested. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function referenceTrackingAPIAsyncWithHttpInfo($reference_number, $trans_id, $transaction_src, $locale = 'en_US', $from_pick_up_date = 'currentDate-14', $to_pick_up_date = 'currentDate', $ref_num_type = 'SmallPackage. Valid values: SmallPackage, fgv')
    {
        $returnType = '\UPS\Tracking\Tracking\TrackApiResponse';
        $request = $this->referenceTrackingAPIRequest($reference_number, $trans_id, $transaction_src, $locale, $from_pick_up_date, $to_pick_up_date, $ref_num_type);
    ...
    /**
     * Create request for operation 'referenceTrackingAPI'
     *
     * @param  string $reference_number The reference number for which tracking information is requested. (required)
     * @param  string $trans_id An identifier unique to the request. (required)
     * @param  string $transaction_src Identifies the client/source application that is calling (required)
    ...
    protected function referenceTrackingAPIRequest($reference_number, $trans_id, $transaction_src, $locale = 'en_US', $from_pick_up_date = 'currentDate-14', $to_pick_up_date = 'currentDate', $ref_num_type = 'SmallPackage. Valid values: SmallPackage, fgv')
    {
        ...
        if ($reference_number === null || (is_array($reference_number) && count($reference_number) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $reference_number when calling referenceTrackingAPI'
            );
        }
        // verify the required parameter 'trans_id' is set
        if ($trans_id === null || (is_array($trans_id) && count($trans_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $trans_id when calling referenceTrackingAPI'
            );
        }
        // verify the required parameter 'transaction_src' is set
        if ($transaction_src === null || (is_array($transaction_src) && count($transaction_src) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $transaction_src when calling referenceTrackingAPI'
            );
        }

        $resourcePath = '/track/v1/reference/details/{referenceNumber}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($from_pick_up_date !== null) {
            $queryParams['fromPickUpDate'] = ObjectSerializer::toQueryValue($from_pick_up_date, null);
        }
        // query params
        if ($to_pick_up_date !== null) {
            $queryParams['toPickUpDate'] = ObjectSerializer::toQueryValue($to_pick_up_date, null);
        }
        // query params
        if ($ref_num_type !== null) {
            $queryParams['refNumType'] = ObjectSerializer::toQueryValue($ref_num_type, null);
        }
        // header params
        if ($trans_id !== null) {
            $headerParams['transId'] = ObjectSerializer::toHeaderValue($trans_id);
