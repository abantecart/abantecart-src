...
class DeliveryDate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeliveryDate';
     ...
     * Sets date
     *
     * @param string $date The date of this delivery detail. Format - YYYYMMDD
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type The list of delivery dates associated with the package. Valid values: SDD - Scheduled Delivery Date RDD - Rescheduled Delivery Date DEL - Delivered Date
     *
     * @return $this
     */
