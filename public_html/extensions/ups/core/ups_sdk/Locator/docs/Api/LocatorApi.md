# UPS\Locator\LocatorApi

All URIs are relative to *https://wwwcie.ups.com/api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**deprecatedLocator**](LocatorApi.md#deprecatedlocator) | **POST** /locations/{deprecatedVersion}/search/availabilities/{reqOption} | Locator
[**locator**](LocatorApi.md#locator) | **POST** /locations/{version}/search/availabilities/{reqOption} | Locator

# **deprecatedLocator**
> \UPS\Locator\Locator\LOCATORResponseWrapper deprecatedLocator($body, $deprecated_version, $req_option, $trans_id, $transaction_src, $locale)
...
$apiInstance = new UPS\Locator\Request\LocatorApi(
...
try {
    $result = $apiInstance->deprecatedLocator($body, $deprecated_version, $req_option, $trans_id, $transaction_src, $locale);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LocatorApi->deprecatedLocator: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling LocatorApi->locator: ', $e->getMessage(), PHP_EOL;
}
?>
```
