...
class LocatorApi
{
     ...
     */
    public function deprecatedLocator($body, $deprecated_version, $req_option, $trans_id = null, $transaction_src = 'testing', $locale = 'en_US')
    {
        list($response) = $this->deprecatedLocatorWithHttpInfo($body, $deprecated_version, $req_option, $trans_id, $transaction_src, $locale);
        return $response;
    }

    /**
     * Operation deprecatedLocatorWithHttpInfo
     *
     * Locator
     *
     * @param  \UPS\Locator\Locator\LOCATORRequestWrapper $body Generate sample code for popular API requests by selecting an example below. To view a full sample request and response, first click \&quot;Authorize\&quot; and enter your application credentials, then populate the required parameters above and click \&quot;Try it out\&quot;. (required)
     ...
     */
    public function deprecatedLocatorWithHttpInfo($body, $deprecated_version, $req_option, $trans_id = null, $transaction_src = 'testing', $locale = 'en_US')
    {
        $returnType = '\UPS\Locator\Locator\LOCATORResponseWrapper';
        $request = $this->deprecatedLocatorRequest($body, $deprecated_version, $req_option, $trans_id, $transaction_src, $locale);
    ...
    /**
     * Operation deprecatedLocatorAsync
     *
     * Locator
     *
     * @param  \UPS\Locator\Locator\LOCATORRequestWrapper $body Generate sample code for popular API requests by selecting an example below. To view a full sample request and response, first click \&quot;Authorize\&quot; and enter your application credentials, then populate the required parameters above and click \&quot;Try it out\&quot;. (required)
     ...
     */
    public function deprecatedLocatorAsync($body, $deprecated_version, $req_option, $trans_id = null, $transaction_src = 'testing', $locale = 'en_US')
    {
        return $this->deprecatedLocatorAsyncWithHttpInfo($body, $deprecated_version, $req_option, $trans_id, $transaction_src, $locale)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deprecatedLocatorAsyncWithHttpInfo
     *
     * Locator
     *
     * @param  \UPS\Locator\Locator\LOCATORRequestWrapper $body Generate sample code for popular API requests by selecting an example below. To view a full sample request and response, first click \&quot;Authorize\&quot; and enter your application credentials, then populate the required parameters above and click \&quot;Try it out\&quot;. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deprecatedLocatorAsyncWithHttpInfo($body, $deprecated_version, $req_option, $trans_id = null, $transaction_src = 'testing', $locale = 'en_US')
    {
        $returnType = '\UPS\Locator\Locator\LOCATORResponseWrapper';
        $request = $this->deprecatedLocatorRequest($body, $deprecated_version, $req_option, $trans_id, $transaction_src, $locale);
    ...
    /**
     * Create request for operation 'deprecatedLocator'
     *
     * @param  \UPS\Locator\Locator\LOCATORRequestWrapper $body Generate sample code for popular API requests by selecting an example below. To view a full sample request and response, first click \&quot;Authorize\&quot; and enter your application credentials, then populate the required parameters above and click \&quot;Try it out\&quot;. (required)
     * @param  string $deprecated_version Version of API  Valid values: - v1 (required)
     * @param  string $req_option Indicates the type of request. Valid values: 1-Locations (Drop Locations and Will call locations) 8-All available Additional Services 16-All available Program Types 24-All available Additional Services and Program types 32-All available Retail Locations 40-All available Retail Locations and Additional Services  48-All available Retail Locations and Program Types  56-All available Retail Locations, Additional Services and Program Types  64-Search for UPS Access Point Locations. (required)
     ...
     */
    protected function deprecatedLocatorRequest($body, $deprecated_version, $req_option, $trans_id = null, $transaction_src = 'testing', $locale = 'en_US')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling deprecatedLocator'
            );
        }
        ...
        if ($deprecated_version === null || (is_array($deprecated_version) && count($deprecated_version) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $deprecated_version when calling deprecatedLocator'
            );
        }
        // verify the required parameter 'req_option' is set
        if ($req_option === null || (is_array($req_option) && count($req_option) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $req_option when calling deprecatedLocator'
            );
        }
