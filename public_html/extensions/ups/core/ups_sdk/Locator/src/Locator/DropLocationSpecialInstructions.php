 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DropLocationSpecialInstructions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DropLocation_SpecialInstructions';
     ...
     * Sets segment
     *
     * @param string[] $segment Walking directions, last 50 feet. **NOTE:** For versions >= v3, this element will always be returned as an array. For requests using version = v1 and v2, this element will be returned as an array if there is more than one object and a single object if there is only 1.
     *
     * @return $this
     */
