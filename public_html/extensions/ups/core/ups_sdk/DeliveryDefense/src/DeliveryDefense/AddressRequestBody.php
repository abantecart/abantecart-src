...
/**
 * AddressRequestBody Class Doc Comment
 *
 * @category Class
 * @package  UPS\DeliveryDefense
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AddressRequestBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AddressRequestBody';
     ...
     * Sets street
     *
     * @param  $street Indicates street address and unit number (if applicable) required for lookup
     *
     * @return $this
     */
     ...
     * Sets city
     *
     * @param  $city Indicates city required for lookup
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param  $state Indicates state required for lookup
     *
     * @return $this
     */
     ...
     * Sets zip_code
     *
     * @param  $zip_code Indicates zipcode required for lookup
     *
     * @return $this
     */
