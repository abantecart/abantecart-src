...
/**
 * BSISV1ChargeDetail Class Doc Comment
 *
 * @category Class
 * @package  UPS\GlobalCheckout
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BSISV1ChargeDetail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BSIS_v1_ChargeDetail';
     ...
     * Sets value
     *
     * @param  $value The value of a particular item in the shipment .
     *
     * @return $this
     */
     ...
     * Sets currency_code
     *
     * @param  $currency_code Currency Code of the unit total value adhering to ISO 4217 standard. Click <a href=\"https://developer.ups.com/api/reference/globalcheckout/appendix?loc=en_US\" target=\"_blank\" rel=\"noopener noreferrer\">here</a> for more information.
     *
     * @return $this
     */
