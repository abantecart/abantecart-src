<?php
/**
 * BSISV1ShipmentItemRequestDimension
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * BSISV1ShipmentItemRequestDimension Class Doc Comment
 *
 * @category Class
 * @package  UPS\GlobalCheckout
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BSISV1ShipmentItemRequestDimension implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BSIS_v1_ShipmentItemRequest_dimension';
     ...
     * Sets length
     *
     * @param  $length package length (no limit).
     *
     * @return $this
     */
     ...
     * Sets width
     *
     * @param  $width package width (no limit).
     *
     * @return $this
     */
     ...
     * Sets height
     *
     * @param  $height package height (no limit).
     *
     * @return $this
     */
     ...
     *
     * @param  $unit_of_measure Specifies the units of measure.
     *
     * @return $this
     */
