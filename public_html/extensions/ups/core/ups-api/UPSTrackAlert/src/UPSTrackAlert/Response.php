...
class Response implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'errors' => '\UPS\UPSTrackAlert\UPSTrackAlert\ErrorMessage[]'
    ];
     ...
     * Gets errors
     *
     * @return \UPS\UPSTrackAlert\UPSTrackAlert\ErrorMessage[]
     */
     ...
     * Sets errors
     *
     * @param \UPS\UPSTrackAlert\UPSTrackAlert\ErrorMessage[] $errors The error response containing any errors that occurred.
     *
     * @return $this
     */
