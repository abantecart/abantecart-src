...
/**
 * PickupCreationResponseRateStatus Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PickupCreationResponseRateStatus implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PickupCreationResponse_RateStatus';
     ...
     * Sets description
     *
     * @param string $description The matching description of rating status code (see above).
     *
     * @return $this
     */
