 ...
 *
 * @category Class
 * @description The code representing the unit of measurement associated with the package.
 * @package  UPS\Pickup
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DimensionsUnitOfMeasurement implements ModelInterface, ArrayAccess
{
     ...
     * Sets description
     *
     * @param string $description See Code above.
     *
     * @return $this
     */
