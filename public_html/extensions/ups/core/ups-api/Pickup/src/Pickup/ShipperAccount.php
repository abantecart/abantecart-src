...
/**
 * ShipperAccount Class Doc Comment
 *
 * @category Class
 * @description Shipper account information.  Must provide when choose to pay the pickup by shipper account number
 * @package  UPS\Pickup
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ShipperAccount implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Shipper_Account';
     ...
     * Sets account_number
     *
     * @param string $account_number UPS account number.  Shipper's (requester of the pickup) UPS account number
     *
     * @return $this
     */
     ...
     *
     * @param string $account_country_code Country or territory code as defined by ISO-3166. Refer to Country or Terriotry Codes in the Appendix for valid values.
     *
     * @return $this
     */
