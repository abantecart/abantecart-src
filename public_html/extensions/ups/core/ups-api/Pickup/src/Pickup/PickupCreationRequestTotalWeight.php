...
/**
 * PickupCreationRequestTotalWeight Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PickupCreationRequestTotalWeight implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PickupCreationRequest_TotalWeight';
     ...
     * Sets weight
     *
     * @param string $weight The weight of the package.  One decimal digit is allowed. Example: 10.9
     *
     * @return $this
     */
     ...
     *
     * @param string $unit_of_measurement The code representing the unit of measurement associated with the package. LBS = Pounds KGS = Kilograms
     *
     * @return $this
     */
