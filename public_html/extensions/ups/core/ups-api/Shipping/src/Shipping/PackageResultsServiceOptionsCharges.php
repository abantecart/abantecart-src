 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PackageResultsServiceOptionsCharges implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PackageResults_ServiceOptionsCharges';
     ...
     * Sets currency_code
     *
     * @param string $currency_code Package accessorial charges currency code type. The currency code used in the Shipment request is returned.
     *
     * @return $this
     */
     ...
     * Sets monetary_value
     *
     * @param string $monetary_value Package accessorial charges value amount.  Valid values are from 0 to 99999999999999.99
     *
     * @return $this
     */
