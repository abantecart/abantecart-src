 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ShipmentInvoiceLineTotal implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Shipment_InvoiceLineTotal';
     ...
     * Sets monetary_value
     *
     * @param string $monetary_value Invoice Line Total amount for the entire shipment.  Valid values are from 1 to 99999999
     *
     * @return $this
     */
