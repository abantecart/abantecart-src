 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RatedShipmentTotalCharges implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RatedShipment_TotalCharges';
     ...
     * Sets currency_code
     *
     * @param string $currency_code The IATA currency code associated with the total charges for the shipment.
     *
     * @return $this
     */
     ...
     * Sets monetary_value
     *
     * @param string $monetary_value The value for the total charges associated with the shipment.
     *
     * @return $this
     */
