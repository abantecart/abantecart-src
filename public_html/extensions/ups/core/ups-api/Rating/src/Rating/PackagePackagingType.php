 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PackagePackagingType implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Package_PackagingType';
     ...
     * Sets description
     *
     * @param string $description A text description of the code for the UPS packaging type associated with the shipment.  Length is not validated.
     *
     * @return $this
     */
