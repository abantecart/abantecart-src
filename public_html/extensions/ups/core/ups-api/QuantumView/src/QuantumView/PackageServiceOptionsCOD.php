...
class PackageServiceOptionsCOD implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'cod_code' => 'string',
        'cod_amount' => '\UPS\QuantumView\QuantumView\CODCODAmount'
    ];
    ...
    {
        $this->container['cod_code'] = isset($data['cod_code']) ? $data['cod_code'] : null;
    ...
    {
        return $this->container['cod_code'];
    }

    /**
     * Sets cod_code
     *
     * @param string $cod_code The code associated with the type of COD. Valid values: 1 - Regular COD 2 - Express COD 3 - Tagless COD
     *
     * @return $this
     */
    public function setCodCode($cod_code)
    {
        $this->container['cod_code'] = $cod_code;
     ...
     * Gets cod_amount
     *
     * @return \UPS\QuantumView\QuantumView\CODCODAmount
     */
     ...
     * Sets cod_amount
     *
     * @param \UPS\QuantumView\QuantumView\CODCODAmount $cod_amount cod_amount
     *
     * @return $this
     */
