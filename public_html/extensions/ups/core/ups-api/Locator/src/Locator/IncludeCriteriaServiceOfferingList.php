...
/**
 * IncludeCriteriaServiceOfferingList Class Doc Comment
 *
 * @category Class
 * @description Container to hold end point service offering List for UPS Access point. Applicable only when a UPS Access Point candidate list is obtained in search by address or geocode search.
 * @package  UPS\Locator
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IncludeCriteriaServiceOfferingList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IncludeCriteria_ServiceOfferingList';
     ...
     *
     * @param \UPS\Locator\Locator\ServiceOfferingListServiceOffering[] $service_offering service_offering
     *
     * @return $this
     */
