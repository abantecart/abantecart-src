...
class Service implements ModelInterface, ArrayAccess
{
     ...
     * Sets code
     *
     * @param string $code The service name code.
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description The service name description. Note that this field will be translated based on the locale provided in the request.
     *
     * @return $this
     */
     ...
     * Sets level_code
     *
     * @param string $level_code levelCode
     *
     * @return $this
     */
