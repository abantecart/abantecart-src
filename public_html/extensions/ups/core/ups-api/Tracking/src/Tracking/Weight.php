...
class Weight implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $unit_of_measurement The weight units of measurement. Valid values: 'LBS' - pounds. 'KGS' - kilograms.
     *
     * @return $this
     */
     ...
     * Sets weight
     *
     * @param string $weight The weight units of measurement. Valid values: 'LBS' - pounds. 'KGS' - kilograms.
     *
     * @return $this
     */
