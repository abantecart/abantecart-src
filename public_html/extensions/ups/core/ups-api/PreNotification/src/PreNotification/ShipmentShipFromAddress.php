...
class ShipmentShipFromAddress implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $state_province_code The Ship From location's state or province code.
     *
     * @return $this
     */
     ...
     * Sets postal_code
     *
     * @param string $postal_code The Ship From location's postal code. 9 characters are accepted.
     *
     * @return $this
     */
     ...
     * Sets country_code
     *
     * @param string $country_code The Ship From location's country or territory code.
     *
     * @return $this
     */
