...
$lng_code = "fr";
$lng_name = "Français";
$lng_directory = "french";
$lng_locale = "fr_FR.UTF-8,fr_FR,fr-fr,french";
$lng_flag_path = "extensions/default_french/storefront/language/french/flag.png";
...
$xml = simplexml_load_file(DIR_EXT . 'default_french/menu.xml');
$routes = array(
