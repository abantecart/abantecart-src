...
$lng_code = "no";
$lng_name = "Bokmål";
$lng_directory = "norwegian";
$lng_locale = "no_NO.UTF-8,no_NO,no-no,norwegian";
$lng_flag_path = "extensions/default_norwegian/storefront/language/norwegian/flag.png";
...
$xml = simplexml_load_file(DIR_EXT . 'default_norwegian/menu.xml');
$routes = array(
