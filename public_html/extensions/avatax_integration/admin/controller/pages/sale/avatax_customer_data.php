...
class ControllerPagesSaleAvataxCustomerData extends AController{
	...
	public function main(){
		...
		if ($this->request->is_POST() && $this->_validateForm()) {
			...
			$this->model_extension_avatax_integration->setCustomerSettings($this->request->get['customer_id'], $this->request->post);
	...
	private function _getForm(){
		...
		$this->data['heading_title'] = $this->language->get('text_edit') . $this->language->get('text_customer') . ' - ' . $customer_info['firstname'] . ' ' . $customer_info['lastname'];
