...
class ControllerPagesCatalogAvataxIntegration extends AController {
	...
	public function main() {
		...
		if ($this->request->is_POST() && $this->_validateForm()) {
			$this->model_extension_avatax_integration->setProductTaxCode($this->request->get['product_id'], $this->request->post['name']);
			$this->session->data['success'] = $this->language->get('text_success');
			$this->redirect($this->html->getSecureURL('catalog/avatax_integration', '&product_id=' . $this->request->get['product_id'] ));
		}
		...
		$this->document->addBreadcrumb( array (
			'href'      => $this->html->getSecureURL('catalog/avatax_integration', '&product_id=' . $this->request->get['product_id'] ),
		...
		$this->data['avatax_integration'] = $this->model_extension_avatax_integration->getProductTaxCode($this->request->get['product_id']);
		...
		$this->data['action'] = $this->html->getSecureURL('catalog/avatax_integration', '&product_id=' . $this->request->get['product_id'] );
