...
class ControllerPagesTotalAvataxIntegrationTotal extends AController {
	...
	public function main() {
		...
		if ($this->request->is_POST() && $this->_validate()) {
			...
			$this->redirect($this->html->getSecureURL('total/avatax_integration_total'));
		}
		...
		$this->data ['update'] = $this->html->getSecureURL ( 'listing_grid/total/update_field', '&id=avatax_integration_total' );
