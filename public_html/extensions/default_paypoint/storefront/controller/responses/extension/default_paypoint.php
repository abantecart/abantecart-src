...
class ControllerResponsesExtensionDefaultPaypoint extends AController
{
    ...
    public function main()
    {
        ...
        $this->data['merchant'] = $this->config->get('default_paypoint_merchant');
        ...
        $this->data['callback'] = $this->html->getSecureURL('extension/paypoint/callback');
    ...
    public function callback()
    {
        ...
        $this->data['text_failure_wait'] = sprintf($this->language->get('text_failure_wait'), $this->html->getSecureURL('checkout/cart'));
