...
if ( $resource_id ) {
	...
	$settings['default_pp_express_payment_storefront_icon'] =  'index.php?rt=r/common/resource/getImageThumbnail&resource_id='.$resource_id;

}
$logo_id = $rm->getIdFromUri($this->config->get('config_logo'));
$settings['default_pp_express_custom_logo'] = 'index.php?rt=r/common/resource/getImageThumbnail&resource_id='.$logo_id.'&width=190&height=60';