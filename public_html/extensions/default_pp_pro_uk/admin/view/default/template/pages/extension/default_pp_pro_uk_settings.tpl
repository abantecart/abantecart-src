	...
	<div class="fieldset">
		...
		<div class="fieldset">
			...
			<div class="cont_left"><div class="cont_right"><div class="cont_mid">
				...
				<table>
					<tr>
						<td width="150" style="padding-right: 40px;"><img src="<?php echo HTTP_EXT . 'default_pp_pro_uk/image/all_in_one_solution_logo_u2645_normal.gif'; ?>"/></td>
						...
						<td style="padding-right: 10px;"><?php echo $settings['default_pp_pro_uk_status']['note']; ?></td>
						<td class="ml_field"><?php echo $settings['default_pp_pro_uk_status']['value']; ?></td>
					</tr>
				</table>
