...
class ControllerResponsesExtensionCardConnect extends AController{
	...
	public function main(){
		...
		$this->data['cc_owner'] = HtmlElementFactory::create(array (
				'type'        => 'input',
				'name'        => 'cc_owner',
		...
		for ($i = 1; $i <= 12; $i++) {
			$this->data['months'][sprintf('%02d', $i)] = sprintf('%02d - ', $i) . strftime('%B',
		...
		$this->data['action'] = $this->html->getSecureURL('extension/cardconnect/send', '', true);
