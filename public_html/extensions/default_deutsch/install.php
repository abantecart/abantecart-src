...
$lng_code = "de";
$lng_name = "Deutsch";
$lng_directory = "deutsch";
$lng_locale = "de_DE.UTF-8,de_DE,de-de,deutsch";
$lng_flag_path = "extensions/default_deutsch/storefront/language/deutsch/flag.png";
...
$xml = simplexml_load_file(DIR_EXT . 'default_deutsch/menu.xml');
$routes = array(
