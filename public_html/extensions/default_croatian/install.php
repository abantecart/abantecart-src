...
$lng_code = "hr";
$lng_name = "Hrvatski";
$lng_directory = "croatian";
$lng_locale = "hr_HR.UTF-8,hr_HR,hr-hr,croatian";
$lng_flag_path = "extensions/default_croatian/storefront/language/croatian/flag.png";
...
$xml = simplexml_load_file(DIR_EXT . 'default_croatian/menu.xml');
$routes = array(
