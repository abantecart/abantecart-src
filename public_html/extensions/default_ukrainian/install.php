...
$lng_code = "uk";
$lng_name = "Українська";
$lng_directory = "ukrainian";
$lng_locale = "uk_UA.UTF-8,uk_UA,uk-uA,ukrainian";
$lng_flag_path = "extensions/default_ukrainian/storefront/language/ukrainian/flag.png";
...
$xml = simplexml_load_file(DIR_EXT . 'default_ukrainian/menu.xml');
$routes = array(
