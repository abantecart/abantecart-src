...
foreach($presetFiles as $preset) {
   ...
   $newPreset['gjs-html'] = preparePreset($pbTemplateData['gjs-html'],'html', $bs5Blocks);
   $newPreset['gjs-components'] = preparePreset($pbTemplateData['gjs-components'],'components', $bs5Blocks);
