...
$lng_code = "lt";
$lng_name = "Lietuvių kalba";
$lng_directory = "lithuanian";
$lng_locale = "lt_LT.UTF-8,lt_LT,lt-lt,lithuanian";
$lng_flag_path = "extensions/default_lithuanian/storefront/language/lithuanian/flag.png";
...
$xml = simplexml_load_file(DIR_EXT . 'default_lithuanian/menu.xml');
$routes = array(
