...
CREATE INDEX `ac_order_history_idx` ON `ac_order_history` (`order_id`, `order_status_id`, `notify`);
CREATE INDEX `ac_order_options_idx` ON `ac_order_options` (`order_id`, `order_product_id`, `product_option_value_id`);
