...
<div class="row">
	...
	<div class="panel-body panel-body-nopadding">
		...
		<p class="text-center">
			<i class="fa fa-home fa-fw"></i> <a href="https://www.abantecart.com" target="_abante">Project Homepage</a>&nbsp;&nbsp;
			<i class="fa fa-graduation-cap fa-fw"></i> <a href="https://docs.abantecart.com" target="_abantecart_docs">Documentation</a>&nbsp;&nbsp;
			<i class="fa fa-puzzle-piece fa-fw"></i> <a href="https://marketplace.abantecart.com" target="_blank">Marketplace</a>&nbsp;&nbsp;
			<i class="fa fa-comments fa-fw"></i> <a href="https://forum.abantecart.com" target="_abante">Support Forums</a></p>

		<div class="container-fluid text-center">
			<a href="https://www.abantecart.com/contribute-to-abantecart"><img src="<?php echo $template_dir; ?>image/conrib_btn_sm.png" style="border:0;" alt="Support AbanteCart eCommerce" /></a>
		</div>

		<div class="container-fluid">
	    <div class="snapshots col-md-6">
		    <a href="../"><img src="<?php echo $template_dir; ?>image/storefront.png" alt="your storefront" style="width: 250px; border: none;" /></a><br />
        ...
        <div class="container-fluid installation-complete">
            ...
            <div class="snapshots col-md-2">
                ...
                <a href="<?php echo $url;?>" target="_new_admin">
                    <img src="../extensions/default_free_shipping/image/icon.png" alt="Install Free Shipping"/>
                </a>
                <br />
            ...
            <div class="snapshots col-md-2">
                ...
                <a href="<?php echo $url;?>" target="_new_admin">
                    <img src="../extensions/default_fedex/image/icon.png" alt="Install FedEx Shipping"/>
                </a>
                <br />
            ...
            <div class="snapshots col-md-2">
                ...
                <a href="<?php echo $url;?>" target="_new_admin">
                    <img src="../admin/view/default/image/default_extension.png" alt="Many other options"/>
                </a>
                <br />
