...
class ControllerResponsesListingGridExtension extends AController
{
    public function main()
    {
        ...
        $limit = max(1, (int)$this->request->post['rows']); // get how many rows we want to have into the grid
        ...
        // $response->rows = array_slice($response->rows, $slice_offset, $limit);
    ...
    public function license()
    {
        ...
        if ($result) {
            ...
            if (file_exists(DIR_EXT . $this->request->get['extension'] . DS . "license.txt")) {
                $this->data['license_text'] = file_get_contents(
                    DIR_EXT . $this->request->get['extension'] . DS . "license.txt"
                );
