...
class ControllerPagesCatalogProductFiles extends AController
{
    ...
    public function main()
    {
        ...
        if (!$this->config->get('config_download')) {
            $this->error['warning'] = $this->html->convertLinks(
                $this->language->get('error_downloads_disabled')
            );
        }
        ...
        foreach ($this->data['product_files'] as &$file) {
            ...
            $thumbnail = $rl->getResourceThumb($resource_id, $this->config->get(
            ...
            $file['status'] = $file['status'] ? $this->language->get(
                'text_enabled'
            ) : $this->language->get('text_disabled');

            $file['button_edit'] = $this->html->buildElement(array(
                'type' => 'button',
            ...
            $file['button_delete'] = $this->html->buildElement(array(
                'type' => 'button',
                'text' => $text,
                'href' => $this->html->getSecureURL(
                    'catalog/product_files',
            ...
            if ($orders_count) {
                $file['push_to_customers'] = $this->html->buildElement(array(
                    'type' => 'button',
        ...
        $this->data['button_add_file'] = $this->html->buildElement(array(
            'type' => 'button',
