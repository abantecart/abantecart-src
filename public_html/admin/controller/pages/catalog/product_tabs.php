...
class ControllerPagesCatalogProductTabs extends AController
{
    ...
    public function main()
    {
        ...
        $this->data['link_images'] = $this->html->getSecureURL(
            'catalog/product_images',
            '&product_id='.$product_id
        );

        $this->data['link_options'] = $this->html->getSecureURL(
            'catalog/product_options',
            '&product_id='.$product_id
        );

        $this->data['link_files'] = $this->html->getSecureURL(
        ...
        $this->data['link_extensions'] = $this->html->getSecureURL(
            'catalog/product_extensions',
            '&product_id='.$product_id
        );
