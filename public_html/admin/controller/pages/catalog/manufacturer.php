...
class ControllerPagesCatalogManufacturer extends AController
{
    ...
    private function getForm($args = array())
    {
        ...
        if (!$manufacturer_id) {
            ...
            $this->data['heading_title'] = $this->language->get(
                'text_edit'
            ).$this->language->get('text_manufacturer').'-'.$this->data['name'];
    ...
    private function validateForm()
    {
        ...
        $id_manufacturer = $this->request->get['manufacturer_id'];
        $keyword = $this->request->post['keyword'];
        if ($error_text = $this->html->isSEOkeywordExists('manufacturer_id='.$id_manufacturer, $keyword)) {
