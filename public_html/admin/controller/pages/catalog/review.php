...
class ControllerPagesCatalogReview extends AController
{
    ...
    public function main()
    {
        ...
        $form = new AForm();
        $form->setForm(array('form_name' => 'review_grid_search'));
        ...
        $grid_search_form['fields']['product_id'] = $form->getFieldHtml(array(
            ...
            'options' => array('' => $this->language->get(
                'text_select_product'
            )) + $this->model_catalog_review->getReviewProducts(),
            'style' => 'chosen'
        ));
        ...
        $grid_settings['colModel'] = array(
            ...
            array('name' => 'name', 'index' => 'name', 'width' => 190, 'align' => 'left'),
            array('name' => 'author', 'index' => 'author', 'width' => 90, 'align' => 'center'),
            array('name' => 'rating', 'index' => 'rating', 'width' => 60, 'align' => 'center', 'search' => false),
            array('name' => 'status', 'index' => 'status', 'width' => 130, 'align' => 'center', 'search' => false),
            array(
                'name' => 'date_added',
                'index' => 'date_added',
                'width' => 90,
    ...
    private function _getForm()
    {
        ...
        if ($product_info) {
            ...
            $this->data['preview'] = $this->html->getCatalogURL(
                'product/product',
        ...
        $form->setForm(array('form_name' => 'reviewFrm', 'update' => $this->data['update']));
