    ...
    */
    ...
    public function main()
    {
        ...
        */
        ...
        $grid_settings['colModel'] = array(
            array('name' => 'name', 'index' => 'name', 'align' => 'left'),
            array('name' => 'attribute_type', 'index' => 'type_name', 'align' => 'left', 'width' => 90),
            array(
                'name' => 'sort_order',
                'index' => 'sort_order',
                'align' => 'center',
            ...
            array('name' => 'status', 'index' => 'status', 'align' => 'center', 'width' => 80, 'search' => false)
        );
    ...
    private function getForm()
    {
        ...
        */
        ...
        $this->initTabs($attribute_type_id);

        /**
         * NOTE: Future implementation ??????????? OR DEPRECATED
        */
        /**
        $attribute_groups = array('' => $this->language->get('text_select'));
        $results = $this->attribute_manager->getAttributeGroups(
            array('language_id' => $this->session->data['content_language_id'])
        );
        foreach ($results as $type) {
        ...
        */
        ...
        if (!$attribute_id) {
            ...
            $this->data['update'] = $this->html->getSecureURL(
                'listing_grid/attribute/update_field',
                '&id='.$attribute_id
            );
            $form = new AForm('HT');
    ...
    private function initTabs($active = null)
    {
        ...
        foreach ($this->data['attribute_types'] as $type_id => $type) {
            ...
            */
            ...
            'text' => $type['type_name'],
            'href' => $method == 'insert' ? $this->html->getSecureURL(
                'catalog/attribute/'.$method,
