...
class ControllerPagesCatalogProductPromotions extends AController
{
    ...
    public function main()
    {
        ...
        if ($this->request->is_POST() && $this->validateForm()) {
            ...
            /* verific redirect is function or obj?? note cali-gula */
        ...
        $this->data['button_edit'] = $this->html->buildElement(array(
            'type' => 'button',
            'text' => $this->language->get('button_edit'),
            'style' => 'button2'
        ));

        $this->data['button_add_discount'] = $this->html->buildElement(array(
            'type' => 'button',
        ...
        $this->data['button_add_special'] = $this->html->buildElement(array(
            'type' => 'button',
        ...
        /* oad tabs controller */
        $tabs_obj = $this->dispatch(
            'pages/catalog/product_tabs',
            array($this->data)
        );
