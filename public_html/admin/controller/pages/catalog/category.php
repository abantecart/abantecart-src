...
class ControllerPagesCatalogCategory extends AController
{
        ...
        */
        ...
        if ($this->request->is_POST() && $this->validateForm()) {
            ...
            foreach ($languages as $l) {
                ...
                $category_lang_ds = $this->request->post['category_description'][$l['language_id']];
                $category_lang_cont = $this->request->post['category_description'][$content_language_id];
                $category_lang_ds = $category_lang_cont;
            }
    ...
    private function getForm($args = array())
    {
        ...
        $this->data['form']['fields']['general']['parent_category'] = $form->getFieldHtml(array(
            'type' => 'selectbox',
            'name' => 'parent_id',
        ...
        */
        ...
        $this->data['form']['fields']['data']['meta_keywords'] = $form->getFieldHtml(array(
            'type' => 'textarea',
        ...
        $this->data['form']['fields']['data']['meta_description'] = $form->getFieldHtml(array(
            'type' => 'textarea',
        ...
        $this->data['form']['fields']['data']['store'] = $form->getFieldHtml(array(
            'type' => 'checkboxgroup',
            'name' => 'category_store[]',
    ...
    private function validateForm()
    {
        ...
        $id_category = $this->request->get['category_id'];
        $keyword_this = $this->request->post['keyword'];
        if ($error_text = $this->html->isSEOkeywordExists('category_id='.$id_category, $keyword_this)) {
