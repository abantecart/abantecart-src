...
class ControllerPagesCatalogProductOptions extends AController
{
    ...
    public function main()
    {
        ...
        $results = $this->attribute_manager->getAttributes(array(
        ...
        $get_product_optin_id = $this->request->get['product_option_id'];
        $product_option_id =  $get_product_optin_id ? $get_product_optin_id : $this->data['product_option_id'];
        ...
        $object_title = $this->language->get(
            'text_product'
        ).'&nbsp;'.$this->language->get('text_option_value');
    ...
    private function validateForm()
    {
        ...
        if ($this->model_catalog_product->isProductGroupOption($product_id, $attribute_id)) {
