	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->_validateForm()) {
		    ...
		    foreach ( $languages as $l ) {
			    ...
			    $this->request->post['length_class_description'][$l['language_id']] = $this->request->post['length_class_description'][ $this->session->data['content_language_id'] ];
		    }
  	...
  	private function _getForm() {
		...
		$this->data['form']['fields']['title'] = $form->getFieldHtml(array(
			'type' => 'input',
			'name' => 'length_class_description['.$this->session->data['content_language_id'].'][title]',
			'value' => $this->data['length_class_description'][$this->session->data['content_language_id']]['title'],
			'required' => true,
			'style' => 'large-field',
		));
		$this->data['form']['fields']['unit'] = $form->getFieldHtml(array(
			'type' => 'input',
			'name' => 'length_class_description['.$this->session->data['content_language_id'].'][unit]',
			'value' => $this->data['length_class_description'][$this->session->data['content_language_id']]['unit'],
			'required' => true,
			'style' => 'large-field',
		));
