...
class ControllerCommonPageLayout extends AController
{
    ...
    public function main()
    {
        ...
        */
        $page_sections = $this->buildPageSections($layout_main_blocks);
     ...
     * @return array
    */
    private function buildPageSections($sections)
    {
        $page_sections = array();
        $partialView = $this->view;
        foreach ($sections as $section) {
            $blocks = $this->buildBlocks($section['block_id'], $section['children']);
     ...
     * @return array
    */
    private function buildBlocks($section_id, $section_blocks)
    {
        $blocks = array();
        $partialView = $this->view;
        ...
        foreach ($section_blocks as $block) {
            ...
            if ($block['custom_block_id']) {
                $customName = $this->getCustomBlockName($block['custom_block_id']);
    ...
    * @return string
    */
    private function getCustomBlockName($custom_block_id)
    {
