    ...
    */
    ...
    public function main()
    {
        ...
        */
        ...
        $config_admin_limit = (int)$this->config->get('config_admin_limit');
        $this->data['rowNum'] = empty($this->data['rowNum']) ? $config_admin_limit : $this->data['rowNum'];
        ...
        foreach ($this->data['colModel'] as $col) {
            if ($col['name'] == 'parent') {
                throw new AException(
                    AC_ERR_LOAD,
                    'Error: Could not create grid. Grid column model contains reserved column name ('.$col['index'].')'
                );
            }
        }
