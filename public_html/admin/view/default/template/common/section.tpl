...
<div class="section <?php echo $class; ?>" data-instance-id="<?php echo $id; ?>" data-section-id="<?php echo $blockId; ?>">
  <div class="section-header">
    ...
    <a class="button sec-add-block" data-toggle="tooltip" data-placement="left"
       title="<?php echo_html2view($text_add_block); ?>" data-add-block="<?php echo_html2view($addBlockUrl);?>">
        <i class="fa fa-plus"></i>
    </a>
    <a class="button sec-switch" data-toggle="tooltip"
       data-placement="left" title="<?php echo_html2view($text_enable); ?>">
