...
<div class="postit_notes_box<?php echo $class_name; ?>">
  <span onClick="$('#postit<?php echo $id; ?>').toggleClass('show');" class="postit_icon"
        title="<?php echo_html2view($text_click); ?>">
  </span>
    <div id="postit<?php echo $id; ?>" class="postit_notes">
        <a class="postit_close" onClick="$('#postit<?php echo $id; ?>').removeClass('show');"
           title="<?php echo_html2view($text_close); ?>">
        ...
        <ul>
            ...
            <li>
                <?php echo $text_block_parent; ?>
                <a class="icon_xpandarrow"
                   onClick="$('#postit_parent<?php echo $id; ?>').toggleClass('expand'); $(this).toggleClass('expand');">
                    <?php echo $parent_block; ?>
                </a>
