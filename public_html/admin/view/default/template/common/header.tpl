			...
			<div class="cr">
				<div class="cc">
					<form id="searchform" action="<?php echo $search_action; ?>" method="post">
						<span class="icon_search">&nbsp;</span><input type="text" name="search"
																	  value="<?php echo $search_everywhere; ?>"
																	  onFocus="if(this.value == '<?php echo $search_everywhere; ?>') {this.value = '';}"
																	  onBlur="if (this.value == '') {this.value = '<?php echo $search_everywhere; ?>';}"/><a
