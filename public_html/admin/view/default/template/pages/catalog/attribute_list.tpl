		...
		<ul class="content-nav">
			<li>
				<div class="dropdown dropdown-toggle">
					<a data-toggle="dropdown" href="#" class="btn btn-primary dropdown-toggle tooltips" title="<?php echo $button_insert; ?>" > <i class="fa fa-plus-circle"></i>  <span class="caret"></span></a>
