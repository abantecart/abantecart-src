...
<div class="contentBox">
  <div class="cbox_tl"><div class="cbox_tr"><div class="cbox_tc">
    <div class="heading icon_title_review"><?php echo $heading_title; ?></div>
	<div class="toolbar">
	  ...
	  <div class="cont_left"><div class="cont_right"><div class="cont_mid">
		...
		<?php foreach ($form['fields'] as $name => $field) { ?>
			<tr>
				...
				<td <?php echo ($name=='rating' || $name=='status' ? '' : 'class="ml_field"' ) ?> >
					<?php if ( $name == 'product') {
	...
	$.ajax({
		...
		success: function(data) {
			for (i = 0; i < data.length; i++) {
	 			$('#reviewFrm_product_id').append('<option value="' + data[i]['product_id'] + '">' + data[i]['name'] + '</option>');
			}
			$('#reviewFrm_product_id').change();
		}
	});
}

$('#reviewFrm_review_categories').change(function(){ getProducts();	});
//--></script>