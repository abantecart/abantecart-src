        ...
        <div class="cbox_tr">
            <div class="cbox_tc">
                ...
                <div class="toolbar">
                    ...
                    <div class="help_element"><a href="<?php echo $help_url; ?>" target="new"><img src="<?php echo $template_dir; ?>image/icons/help.png"/></a>
                    </div>
                    <?php endif; ?>
                            ...
                            <div class="cont_mid">
                                ...
                                <table class="form">
                                    ...
                                    <tr>
                                        ...
                                        <td class="<?php echo ($name == 'block_content' ? 'ml_ckeditor' : ($name == 'block_status' ? '' : 'ml_field')); ?>">
                                            <?php echo $field; ?>
...
<script type="text/javascript">
    $('#BlockFrm_block_content').parents('.afield').removeClass('mask2');
