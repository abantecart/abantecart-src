...
<div id="aPopup">
	...
	<div id="license" class="popbox_cl"><div class="popbox_cr"><div class="popbox_cc" >
		<div class="aform">
		...
		<div class="align_center" style="margin-top: 7px;">
		<a class="btn_standard"><?php echo $cancel_install; ?></a>&nbsp;<a class="btn_standard" id="agree" href=""><?php echo $agree_install; ?></a></div>
	</div></div></div>
