  ...
  <div class="cbox_cl"><div class="cbox_cr"><div class="cbox_cc">
	...
	<div class="extension_info">
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			<tr>
				...
				<?php if($add_sett){ ?>
	            <td><a class="btn_standard" href="<?php echo $add_sett['link']; ?>" target="_blank"><?php echo $add_sett['text']; ?></a></td>
			    <?php }
    ...
    <?php  echo $form['form_open']; ?>
      <table class="form">
        ...
        <?php if ( is_integer($value['note']) ) { echo $value['value']; continue; } ?>
        <tr>
	    ...
	    <tr>
          ...
          <td>
	          <div align="center" style="margin-left:-220px;">
				  <a class="btn_standard" href="<?php echo $reload ?>&restore=1"><?php echo $button_restore_defaults; ?></a>&nbsp;
				  <button class="btn_standard" type="submit"><?php echo $button_save; ?></button>&nbsp;
				  <?php if($add_sett){ ?>
				  <a class="btn_standard" <?php echo $add_sett['onclick']; ?> href="<?php echo $add_sett['link']; ?>" target="_blank"><?php echo $add_sett['text']; ?></a>
				  <?php } ?>
		      </div>
          </td>
        </tr>
	  ...
	  <?php if ($extension['preview']) { ?>
		<div class="product_images">
			<div class="main_image">
				<a href="<?php echo $extension['preview'][0]; ?>" title="<?php echo $heading_title; ?>" class="thickbox" rel="gallery">
					<img width="150" src="<?php echo $extension['preview'][0]; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image" />
				</a>
			</div>
			<?php if ( count($extension['preview']) > 1 ) { ?>
			  <div class="additional_images">
				...
				<div>
					<a href="<?php echo $extension['preview'][$i]; ?>" title="<?php echo $heading_title; ?>" class="thickbox" rel="gallery">
						<img width="50" src="<?php echo $extension['preview'][$i]; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" />
					</a>
				</div>
				<?php } ?>
			  </div>
