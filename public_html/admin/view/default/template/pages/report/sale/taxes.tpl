...
$(document).ready(function() {
	...
	$(function() {
		var dates = $( "#report_taxes_grid_search_date_start, #report_taxes_grid_search_date_end" ).datepicker({
			defaultDate: "-1w",
			dateFormat: '<?php echo $js_date_format?>',
			changeMonth: false,
			numberOfMonths: 1,
			onSelect: function( selectedDate ) {
				var option = this.id == "report_taxes_grid_search_date_start" ? "minDate" : "maxDate",
