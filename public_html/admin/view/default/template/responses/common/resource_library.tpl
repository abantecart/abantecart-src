						...
						foreach ($rls as $rl) {
							...
							<div class="col-xs-6 col-sm-2 col-md-2 document">
								<div class="thmb <?php if ($rl['mapped_to_current']) { echo "mapped"; } ?>" data-rl-id="<?php echo $rl['resource_id']; ?>">
									...
									<?php } ?>
									<h5 class="rl-title"><a class="resource_edit tooltips"
															data-type="<?php echo $type; ?>"
															data-rl-id="<?php echo $rl['resource_id']; ?>"
	...
	jQuery(function ($) {
		...
		function loadResources() {
			...
			/*
			 ...
			 //html = '<div class="no_resource">' + text.text_no_resources + '<div><a class="btn_standard add_resource">
			<?php echo $button_add_resource; ?></a></div></div>';
			 ...
			 <div class="buttons">\
			 <a class="edit" rel="' + item['resource_id'] + '" href="' + urls.get_resource + '&resource_id=' + item['resource_id'] + '"><img src="
			<?php echo $template_dir?>image/icons/icon_s_edit.png" alt="' + text.edit + '" border="0" /></a>\
			 ' + ( item['mapped'] > 0 ? '' : '<a class="delete" rel="resource' + item['resource_id'] + '" href="' + urls.del + '&resource_id=' + item['resource_id'] + '"><img src="
			<?php echo $template_dir?>image/icons/icon_s_delete.png" alt="' + text.del + '" border="0" /></a>') + '\
