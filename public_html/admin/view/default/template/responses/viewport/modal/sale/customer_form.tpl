<div class="modal-header">
    ...
    <a aria-hidden="true" class="btn btn-default" type="button" href="" target="_blank"><i
        ...
        <div class="primary_content_actions pull-left">
            <div class="btn-group">
                <button class="btn btn-default dropdown-toggle tooltips"
                        ...
                        title="<?php echo_html2view($text_edit_address); ?>"
            ...
            <div class="btn-group mr20 toolbar">
                <a class="actionitem btn btn-primary tooltips"
                   href="<?php echo $add_address_url; ?>"
            ...
            <div class="btn-group mr10 toolbar">
                ...
                <a target="_blank"
                   ...
                   data-original-title="<?php echo_html2view($button_orders_count->title); ?>">
                    <?php echo $button_orders_count->text; ?>
                </a>
                <a target="_blank"
                   class="btn btn-white tooltips"
