<div class="modal-content">
    <div class="modal-header">
        ...
        <a aria-hidden="true" class="btn btn-default" type="button" href="" target="_blank"><i class="fa fa-arrow-right fa-fw"></i><?php echo $text_more_new; ?></a>
            ...
            <div class="col-md-12 mb10">
                ...
                <div class="form-group <?php if (!empty($error[$name])) { echo "has-error"; } ?>">
                    ...
                    <div class="input-group afield <?php echo $widthcasses; ?>">
                        <?php if($name == 'keyword') { ?>
                            <span class="input-group-btn"><?php echo $keyword_button; ?></span>
                        <?php }
                        echo $field; ?>
                    </div>
                    <?php if($error[$name]) { ?>
