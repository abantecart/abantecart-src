...
<tr id="<?php echo $row_id; ?>" class="optionRow">
	...
	if($form['fields']['option_value'] && $option_data['element_type'] != 'U'){ ?>
		<td>
			<div class="input-group input-group-sm afield"><?php
				...
				if(in_array($option_data['element_type'], ['T', 'B'])){?>
	...
	<td><div class="input-group input-group-sm afield"><?php echo $form['fields']['prefix']; ?></div></td>
        <?php echo $this->getHookVar('option_value_row_'.$row_id.'_additional_info_1'); ?>
	...
	<td><?php echo $form['fields']['product_option_value_id']; ?>
		<?php if(!in_array($this->data['option_data']['element_type'], ['U', 'B']) ){?>
...
<?php if(!in_array($option_data['element_type'], ['U', 'B'])){ ?>
<tr>
	<td colspan="<?php echo $colspan;?>" >
		<div id="add_<?php echo $row_id; ?>" class="row additionalRow collapse">
			...
			<?php } ?>
            <div class="pull-left col-md-5 col-sm-8 col-xs-12">
                <label class="control-label" for="<?php echo $form['fields']['txt_id']->element_id; ?>">
                    <?php echo $entry_txt_id; ?></label>
                <div class="input-group input-group-sm afield"><?php echo $form['fields']['txt_id']; ?></div>
            </div>
