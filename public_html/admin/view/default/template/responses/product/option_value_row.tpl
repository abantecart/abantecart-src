<tr id="<?php echo $row_id; ?>" class="optionRow">
    ...
    <td><a id="<?php echo $attr_val_id; ?>" title="<?php echo $text_expand ?>" class="expandRow btn btn-info-alt" data-toggle="collapse" data-target="#add_<?php echo $row_id; ?>"><i class="fa fa-expand"></i></a></td>
<?php if ($selectable){?>
    <td><a class="remove btn btn-danger-alt" title="<?php echo $button_remove; ?>"><i class="fa fa-minus-circle"></i></a></td>
<?php } ?>
</tr>
<tr>
