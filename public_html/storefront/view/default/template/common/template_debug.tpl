...
<div class="postit_notes_box<?php echo $class_name; ?>">
  ...
  <div id="postit<?php echo $id; ?>" class="postit_notes">
    <a class="postit_close" onClick="$('#postit<?php echo $id; ?>').removeClass('show');" title="<?php echo $text_close; ?>"><?php echo $text_close; ?>&nbsp;&nbsp;<i class="icon-remove-sign"></i></a>
    <ul>
      ...
      <li>
        <?php echo $text_block_parent; ?>&nbsp;&nbsp;&nbsp;<i class="icon-arrow-right"></i>
