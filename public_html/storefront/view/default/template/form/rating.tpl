...
<div class="form-group mt-2 ms-3">
    <div class="d-flex justify-content-start">
        <input id="<?php echo $id ?>" name="<?php echo $name ?>" class="rating rating-loading visually-hidden" data-min="0" data-max="5" data-step="1" value="0" data-show-caption="false" data-show-clear="false">
    <?php if ( $required){ ?>
