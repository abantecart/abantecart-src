...
<?php foreach((array)$products as $product){
    ...
    html = '
    <li><a data-href="<?php echo $product['product_details_url']; ?>" data-id="<?php echo $product['product_id']; ?>"
           ...
           data-toggle="abcmodal" href="#" class="product_thumb" data-original-title="">'
            + '<?php echo nl2br($product['thumb']['thumb_html']); ?></a>';

        html += '
        <div><h3 class="abantecart_product_name"><a data-href="<?php echo $product['product_details_url']; ?>"
                    ...
                    + '<?php echo nl2br(addslashes($product['name'])); ?></a></h3></div>
        ';
