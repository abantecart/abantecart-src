...
<?php foreach($manufacturers as $manufacturer){
	...
	if($('#<?php echo $target;?> .abantecart_name')){
		html = '<a data-href="<?php echo $manufacturer['details_url'];?>" data-backdrop="static" data-keyboard="false" data-id="<?php echo $manufacturer['manufacturer_id']; ?>" data-html="true" data-target="#abc_embed_modal" data-toggle="abcmodal" href="#">'
			+ '<?php echo $manufacturer['name']?></a>';
		$('#<?php echo $target;?> .abantecart_name').html(html);
	}

	if($('#<?php echo $target;?> .abantecart_image')){
		html = '<a data-href="<?php echo $manufacturer['details_url'];?>" data-backdrop="static" data-keyboard="false" data-id="<?php echo $manufacturer['manufacturer_id']; ?>" data-html="true" data-target="#abc_embed_modal" data-toggle="abcmodal" href="#" class="category_thumb">'
