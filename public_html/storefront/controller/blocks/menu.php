...
class ControllerBlocksMenu extends AController {
	...
	public function main() {
		...
		$cache_name = 'storefront_menu.'.(int)$this->config->get('config_store_id').'_'.$this->config->get('storefront_language_id');
		$this->menu_items = $this->cache->pull($cache_name);
		if($this->menu_items === false){
			...
			$this->cache->push($cache_name, $this->menu_items);
		}
