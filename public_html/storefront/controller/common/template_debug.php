...
class ControllerCommonTemplateDebug extends AController
{
    ...
    public function main($instance_id = 0, $details = [])
    {
        ...
        $this->data['controller_path'] = str_replace(DIR_ROOT.DS, '', $details['block_controller']);
        ...
        $this->data['parent']['controller_path'] = str_replace(DIR_ROOT.DS, '', $details['parent_controller']);
